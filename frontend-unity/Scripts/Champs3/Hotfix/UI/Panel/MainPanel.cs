...
namespace champs3.Hotfix.UI
{
    ...
    public partial class MainPanel : UIPanel
    {
        ...
        protected override void OnInit(IUIData uiData = null)
        {
            ...
            // {
            //     Application.OpenURL("https://twitter.com/champs3xyz");
            // });
            //
            // Telegram.onClick.AddListener(() =>
            // {
            //     Application.OpenURL("https://t.me/champs3xyz");
            // });
            //
        ...
        protected override void OnShow()
        {
            ...
            // champs3NetManager.RegisterHandler<R2C_StartMatchRacing>(KeepOpCode.OP_R2C_StartMatchRacing, OnStartMatch);
            // champs3NetManager.RegisterHandler<MatchProgressMessage>(KeepOpCode.OP_MatchProgressMessage, ToMatch);
        ...
        protected override void OnClose()
        {
            ...
            champs3NetManager.UnRegisterHandler<R2C_StartMatchRacing>(KeepOpCode.OP_R2C_StartMatchRacing, OnStartMatch);
            champs3NetManager.UnRegisterHandler<MatchProgressMessage>(KeepOpCode.OP_MatchProgressMessage, ToMatch);
        ...
        public void StartMatch()
        {
            ...
            //         champs3NetManager.Instance.Send(KeepOpCode.OP_C2R_StartMatchRacing,new C2R_StartMatchRacing(){GameType = _gameType});
            //     }
            //     else
            //     {
