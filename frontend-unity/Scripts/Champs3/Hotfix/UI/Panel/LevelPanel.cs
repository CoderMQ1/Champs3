...
namespace champs3.Hotfix.UI
{
	...
	public partial class LevelPanel : UIPanel
	{
		...
		protected override void OnShow()
		{
			...
			// champs3NetManager.RegisterHandler<RoomUserSettleResult>(KeepOpCode.Op_S2C_RoomUserSettleResult, OnSettle);
		...
		protected override void OnHide()
		{
			...
			// champs3NetManager.UnRegisterHandler<RoomUserSettleResult>(KeepOpCode.Op_S2C_RoomUserSettleResult, OnSettle);
		}
