                    ...
                    var enumerator = Login(GameUrlConstValue.Login.Url(),
                        result =>
                        {
                            ...
                            if (loginResponse.code == 0)
                            {
                                ...
                                champs3NetManager.Instance.Login();
                            }
                        });
        ...
        public static void OnDisconnectServer()
        {
            ...
            UIKit.OpenPanelAsync<NetworkErrorPanel>(panel =>
            {
                ...
                callback = login =>
                {
                    ...
                    champs3NetManager.UnRegisterHandler<G2C_Login>(KeepOpCode.Op_G2C_Login, callback);
                };

                champs3NetManager.RegisterHandler<G2C_Login>(KeepOpCode.Op_G2C_Login, callback);
