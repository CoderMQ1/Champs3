...
namespace SquareHero.Hotfix.UI
{
    ...
    public partial class LuckSpinPanel : UIPanel
    {
        ...
        protected override void OnInit(IUIData uiData = null)
        {
            ...
            RunxNetManager.RegisterHandler<SPinResultMessage>(KeepOpCode.OP_S2C_SPinResultMessage, OnReceiveSpinResult);
            _mainModel = MainController.Instance.GetModel<MainModel>();
            
            ReceiveRewardSubPanel.ShareBtn.onClick.AddListener(() =>
            {
                // Global.Instance.ShareToTwitter.TweetWithScreenshot("I am so lucky! I drew the card I wanted on runx! @runxxyz");
