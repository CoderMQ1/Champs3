...
namespace QFramework
{
    public static class CodeGenUtil
    {
        ...
        public static string GenSourceFilePath(string prefabName)
        {
            var strFilePath = UIKitSettingData.Load().UIScriptDir;
            
            strFilePath.Replace(prefabName + ".prefab", string.Empty).CreateDirIfNotExists();

            strFilePath = $"{UIKitSettingData.Load().UIScriptDir}/{prefabName}.cs";
