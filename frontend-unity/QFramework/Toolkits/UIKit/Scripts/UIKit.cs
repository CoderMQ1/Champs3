...
")]
#endif
        // public static IEnumerator OpenPanelAsync<T>(Action<T> onComplete = null, UILevel canvasLevel = UILevel.Common, IUIData uiData = null,
        //     string assetBundleName = null,
        //     string prefabName = null) where T : UIPanel
        // {
        //     var panelSearchKeys = PanelSearchKeys.Allocate();
        ...
        public static void OpenPanelAsync<T>(Action<T> onComplete = null, UILevel canvasLevel = UILevel.Common, IUIData uiData = null,
            string assetBundleName = null,
            string prefabName = null) where T : UIPanel
        {
            var panelSearchKeys = PanelSearchKeys.Allocate();
...
")]
        ...
        public static void CloseAllOtherPanel<T>() where T : UIPanel
        {
            var panelSearchKeys = PanelSearchKeys.Allocate();
            panelSearchKeys.PanelType = typeof(T);

            UIManager.Instance.CloseAllOtherUI(panelSearchKeys);
...
")]
        ...
        public static void HideOtherAllPanel<T>() where T : UIPanel
        {
            var panelSearchKeys = PanelSearchKeys.Allocate();
            panelSearchKeys.PanelType = typeof(T);

            UIManager.Instance.HideOtherAllUI(panelSearchKeys);
...
")]
        ...
        {
            LogKit.I("EnableUIInput");
            // UIRoot.Instance.EnableUIInput();
        }
        
        public static void DisableUIInput()
        {
            LogKit.I("DisableUIInput");
            // UIRoot.Instance.DisableUIInput();
        }
    }
}