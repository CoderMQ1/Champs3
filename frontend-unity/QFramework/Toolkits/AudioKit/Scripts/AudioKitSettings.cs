...
namespace QFramework
{
    ...
    public class AudioKitSettings
    {
        ...
        const string KEY_AUDIO_MANAGER_MASTER_VOLUME = "KEY_AUDIO_MANAGER_MASTER_VOLUME";
        ...
        public AudioKitSettings()
        {
            ...
            MasterVolume = new PlayerPrefsFloatProperty(KEY_AUDIO_MANAGER_MASTER_VOLUME, 1.0f);
        ...
        public PlayerPrefsFloatProperty MasterVolume { get; private set; }
