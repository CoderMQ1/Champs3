...
")]
            ...
            System.Action onEndCallback = null, bool allowMusicOff = true, float volume = -1f)
        {
            ...
            MusicPlayer.SetOnStartListener(musicUnit =>
            {
                ...
                if (volume < 0)
                {
                    MusicPlayer.SetVolume(Settings.MusicVolume.Value * Settings.MasterVolume.Value);
                }
                else
                {
...
")]
            ...
            int customEventId = -1)
        {
            ...
            {
                player.SetVolume(Settings.SoundVolume.Value * Settings.MasterVolume.Value);
...
")]
            ...
            int customEventId = -1)
        {
            ...
            soundPlayer.SetVolume(Settings.SoundVolume.Value * Settings.MasterVolume.Value);
            soundPlayer.SetOnFinishListener(soundUnit =>
            {
                if (callBack != null)
                {
